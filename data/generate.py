...
#%% Attack on ResNet
adv_folder= 'MIM_1' # Change the name of the folder accordingly
#adv_folder= 'Adversarial_Folder_1' # Change the name of the folder accordingly
...
for i in range(1000):
    ...
    adv= attack(resnet, criterion, img, label, eps=eps, attack_type= 'mim', iters= 1)# Batch-wise attack
